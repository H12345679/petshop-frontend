          ...
          <table class="tbl">
            ...
            <tbody>
              <tr v-for="shop in shops" :key="shop.id">
                <td>
                  <div class="img" :style="shop.logo ? { backgroundImage: 'url(' + shop.logo + ')' } : null">
                ...
                <td class="small">
                  ...
                  <span class="action-btn" @click="toggleStatus(shop)">{{ shop.status === 1 ? '停业' : '营业' }}</span>
                  <span class="action-divider">·</span>
                  <span class="action-btn danger" @click="handleDelete(shop.id)">删除</span>
                </td>
              </tr>
              <tr v-if="shops.length === 0">
                <td colspan="7" class="text-center" style="padding: 40px; color: #888;">暂无数据</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div class="modal-container">
          ...
          <div class="modal-body">
            ...
            <div class="field mb16">
              <label>详细地址</label>
              <div class="input-wrap">
                <input v-model="formData.address" placeholder="街道门牌" style="width: 100%;" />
              </div>
            </div>
            ...
            <div class="row gap16 mb16">
              ...
              <div class="field col flex1">
                ...
                <div class="input-wrap select-wrap">
                  <select v-model="formData.status" style="width: 100%; height: 36px; padding: 0 10px;">
                    <option :value="1">营业中</option>
                    <option :value="0">已停业</option>
                  </select>
                </div>
...
.select-wrap select { width: 100%; border: none; outline: none; background: transparent; cursor: pointer; height: 100%; }
