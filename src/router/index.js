...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'refunds',
        name: 'admin-refunds',
        component: () => import(/* webpackChunkName: "admin" */ '../views/admin/AdminRefundsView.vue'),
        meta: { title: '退单 / 退单审核' }
      }
    ]
  },
  ...
  },
  {
    path: '/messages',
    name: 'messages',
    component: () => import(/* webpackChunkName: "user" */ '../views/MessageCenterView.vue')
  },
  {
    path: '/refund',
    name: 'refund',
    component: () => import(/* webpackChunkName: "order" */ '../views/RefundView.vue'),
    meta: { requiresAuth: true }
  },
  {
    path: '/review',
    name: 'review',
    component: () => import(/* webpackChunkName: "order" */ '../views/ReviewView.vue'),
    meta: { requiresAuth: true }
  }
]
